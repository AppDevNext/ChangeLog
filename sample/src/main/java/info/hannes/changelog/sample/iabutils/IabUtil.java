package info.hannes.changelog.sample.iabutils;
...
import info.hannes.changelog.sample.MainActivity;
import info.hannes.changelog.sample.R;
...
public class IabUtil {
    ...
    public static class PurchaseDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            View rootView = layoutInflater.inflate(R.layout.purchase_about, null);
                ...
                lsmall.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mHelper.launchPurchaseFlow(getActivity(), SMALL_BEER_SKU, 10001,
                                ...
                                }, "bboa+V8g/yqDXvKRqq+JTFn4uQZbPiQJo4pf9RzJ");
                    }
                });
            }
